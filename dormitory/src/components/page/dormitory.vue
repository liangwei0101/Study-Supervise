        ...
        <Form :model="formRight" label-position="right" :label-width="100">
           >
            ...
            <FormItem label="宿舍楼宇">
             ...
             <FormItem label="容纳人数">
                <Input v-model="formRight.input6"/>
            </FormItem>
        </Form>  
    </Modal>
   <!--表单结束 -->
        ...
        methods: {
            ...
            add(){              
                var temp =  {
                        ...
                        dor1: this.formRight.input3,
                         dor2: this.formRight.input4,
                          dor3: this.formRight.input5,
                          amount:this.formRight.input6
                    }
             ...
             edit () {
                ...
                this.editform.input2=this.dataList[this.temp1].number
                this.editform.input3=this.dataList[this.temp1].dor1
                this.editform.input4=this.dataList[this.temp1].dor2
                this.editform.input5=this.dataList[this.temp1].dor3
                  this.editform.input6=this.dataList[this.temp1].amount
            },
            editit(){      
               var temp =  {
                       
                        number: this.editform.input2,
                        dor1: this.editform.input3,
                         dor2: this.editform.input4,
                          dor3: this.editform.input5,
                          amount:this.editform.input6
                    }
